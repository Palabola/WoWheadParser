...
class DB_API {
  replace_creature_parse(array) {
    ...
    pool.query(
      "REPLACE INTO `creature_parse` (`entry`, `modelid1`, `name`, `femaleName`, `subname`, `minlevel`, `maxlevel`, `spell1`, `spell2`, `spell3`, `spell4`, `spell5`, `spell6`, `spell7`, `spell8`, `mingold`, `maxgold`, `VerifiedBuild`) VALUES ?;",
      [array],
      error => {
        if (error) {
  ...
  replace_quest_start_end(array, table) {
    ...
    pool.query(
      "REPLACE INTO `" + table + "` (`id`, `quest`) VALUES ?;",
      [array],
      error => {
        if (error) {
  ...
  replace_npc_vendor(array) {
    ...
    pool.query(
      "REPLACE INTO `npc_vendor` (`entry`, `slot`, `item`, `maxcount`, `incrtime`, `ExtendedCost`, `type`, `BonusListIDs`, `PlayerConditionID`, `IgnoreFiltering`, `OverridePrice`, `VerifiedBuild`) VALUES ?;",
      [array],
      error => {
        if (error) {
